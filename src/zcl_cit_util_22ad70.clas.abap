CLASS zcl_cit_util_22ad70 DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS get_instance
      RETURNING VALUE(ro_instance) TYPE REF TO zcl_cit_util_22ad70.

    METHODS:
      set_hdr_value
        IMPORTING im_sales_hdr TYPE zcit_head_22ad70
        EXPORTING ex_created   TYPE abap_boolean,

      get_hdr_value
        EXPORTING ex_sales_hdr TYPE zcit_head_22ad70,

      set_itm_value
        IMPORTING im_sales_itm TYPE zcit_item_22ad70
        EXPORTING ex_created   TYPE abap_boolean,

      get_itm_value
        EXPORTING ex_sales_itm TYPE zcit_item_22ad70,
  ...
  PRIVATE SECTION.
    ...
    CLASS-DATA:
      gs_sales_hdr_buff TYPE zcit_head_22ad70,
      gs_sales_itm_buff TYPE zcit_item_22ad70,
      gt_sales_hdr_t_buff TYPE tt_sales_hdr,
      gt_sales_itm_t_buff TYPE tt_sales_item,
      gv_so_delete TYPE abap_boolean.

    CLASS-DATA mo_instance TYPE REF TO zcl_cit_util_22ad70.

ENDCLASS.
CLASS zcl_cit_util_22ad70 IMPLEMENTATION.
